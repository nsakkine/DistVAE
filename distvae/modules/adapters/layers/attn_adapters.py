...
class WanAttentionBlockAdapter(torch.nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        dist.all_gather(
            size_list,
            torch.tensor([hidden_states.shape[chunk_dim]], dtype=torch.int64, device=device),
